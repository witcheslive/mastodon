    ...
    return (
      <div className='compose-form__poll-wrapper'>
        ...
        <div className='poll__footer'>
          <button disabled={options.size >= 100} className='button button-secondary' onClick={this.handleAddOption}><Icon id='plus' /> <FormattedMessage {...messages.add_option} /></button>
